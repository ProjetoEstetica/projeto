...
public class ProfissionaisTela {
	...
	public void tableLoad() {
		try {		
			Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/profissionais", "root", "");
			PreparedStatement pst = (PreparedStatement) con.prepareStatement("select id, apelido from cadastro_profissionais");
	...
	private void initialize() {
		...
		panel_2.setBounds(266, 444, 300, 71);
		...
		textLocalizar.setBounds(97, 25, 182, 20);
		...
		btnAlterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, "Profissional Alterado!");
				tableLoad();
			}
		});
